...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const placeholder = createMemo(() => {
    ...
    return new StyledText([fg(input.theme().muted)('Ask anything... "make me an unhinged tsundere dragon gf"')])
  })
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close jclaw" } satisfies SlashOption,
    ]
