...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public shareable link to your conversation",
  ...
  "Create a plugin to prevent jclaw from reading sensitive files",
  "Use {highlight}claw run{/highlight} for non-interactive scripting",
  "Use {highlight}claw --continue{/highlight} to resume the last session",
  "Use {highlight}claw run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}claw serve{/highlight} for headless API access to jclaw",
  "Use {highlight}claw run --attach{/highlight} to connect to a running server",
  "Run {highlight}claw auth list{/highlight} to see all configured providers",
  "Run {highlight}claw agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}claw debug config{/highlight} to troubleshoot configuration",
